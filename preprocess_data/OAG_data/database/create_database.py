...
def create_author_table(conn, cursor, root_dir, data_dir):
    ...
    if exists:
        ...
        ''')
        author_data_dir = "C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Authors/books"
        # load author data
...
if __name__=='__main__':
    root_dir = 'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/preprocess_data/OAG_data'
    year_range = [2000, 2010]
    least_n_citation = 150
    data_dir = f'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/preprocess_data/OAG_data/data_from_{year_range[0]}to{year_range[1]}_gt_{least_n_citation}_citation'
