...
class Platform:
    ...
    def __init__(self,
        ...
        self.agent_pool = [self.init_agent(str(agent_id), agent_model_config_name, 'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Authors/author_{}.txt'.format(agent_id)) for agent_id in range(len(self.adjacency_matrix))]
        ...
        cpu_future_index = faiss.read_index("C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Embeddings/faiss_index_future.index")
        self.gpu_future_index = cpu_future_index  
