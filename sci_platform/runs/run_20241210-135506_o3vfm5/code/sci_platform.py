...
class Platform:
    ...
    def __init__(self,
        ...
        self.agent_pool = [self.init_agent(str(agent_id), agent_model_config_name, 'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Authors/books/author_{}.txt'.format(agent_id)) for agent_id in range(3)]
        print("---------===========================================-----------------")
