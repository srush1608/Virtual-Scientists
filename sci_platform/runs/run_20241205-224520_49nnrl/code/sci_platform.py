...
def load_faiss_index_cpu(index_path):
    """
    Loads a FAISS index from the specified path for CPU use.

    Parameters:
    - index_path: str, path to the FAISS index file.

    Returns:
    - FAISS index object (CPU-based).
    """
    try:
        ...
        embedding_path = "C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Embeddings/faiss_index.index"
        future_embedding_path = "C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Embeddings/faiss_index_future.index"

        # Load the primary index
        self.cpu_index = load_faiss_index_cpu(embedding_path)

        # Load the future index
        self.cpu_future_index = load_faiss_index_cpu(future_embedding_path)
