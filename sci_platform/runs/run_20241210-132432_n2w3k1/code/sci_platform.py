...
class Platform:
    ...
    def __init__(self,
                 model_configuration: str = 'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/sci_platform/configs/model_configs.json',
                 agent_num: int = 1,
                 root_dir: str = 'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main',
                 paper_folder_path: str = "C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Papers",
                 future_paper_folder_path: str = "C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Papers/papers_future",
                 author_info_dir: str = 'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Authors',
                 adjacency_matrix_dir: str = 'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/authors_degree_ge50_from_year2000to2010',
                 agent_model_config_name: str = 'ollama_llama3.1_8b',
                 review_model_config_name: str = 'ollama_llama3.1_70b',
                 knowledgeBank_config_dir: str = "C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/sci_platform/configs/knowledge_config.json",
                # log_dir: str = 'logs',
                 log_dir: str = 'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/sci_platform/team_log',
                 info_dir: str = "C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/sci_platform/team_info",
                 hop_num: int = 2,
        ...
        # self.agent_pool = [self.init_agent(str(agent_id), agent_model_config_name, 'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Authors/books/author_{}.txt'.format(agent_id)) for agent_id in range(len(self.adjacency_matrix))]

        self.agent_pool = [self.init_agent(str(agent_id), agent_model_config_name, 'C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Authors/books/author_{}.txt'.format(agent_id)) for agent_id in range(2)]
        print("---------===========================================-----------------")
        ...
        # cpu_index = faiss.read_index("C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Embeddings/faiss_index.index")
        # res = faiss.StandardGpuResources()  
        # self.gpu_index = faiss.index_cpu_to_gpu(res, 0, cpu_index)  

        # cpu_future_index = faiss.read_index("C:/Users/Coditas-Admin/Desktop\POC\Social_Science-main/Embeddings/faiss_index_future.index")  
        ...
        # Load the paper embedding list on the CPU
        cpu_index = faiss.read_index("C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Embeddings/faiss_index.index")
        self.gpu_index = cpu_index  # Use the CPU index directly as "gpu_index" to keep the rest of your code unchanged

        # Load the future paper embedding list on the CPU
        cpu_future_index = faiss.read_index("C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Embeddings/faiss_index_future.index")
        self.gpu_future_index = cpu_future_index  # Use the CPU index directly as "gpu_future_inde
    ...
    def init_knowledgeBank(self, knowledgeBank_config_dir):
        ...
        knowledge_bank.add_data_as_knowledge(
            ...
            data_dirs_and_types={
                "C:/Users/Coditas-Admin/Desktop/POC/Social_Science-main/Authors/books": [".txt"],
            },
        )
    ...
    def select_coauthors(self,):
        ...
        for agent_index in range(len(scientists)):
            ...
            if match:
                # when action2, the agent chooses to act independently
                if int(match.group(1)) == 2:
                    print("Single Agent Independently!")
                    team_list[agent_index][0].state = 2
                    continue
            else:
                # Log an error or handle the case where no match is found
                print(f"No action found in response: {x.content}")
                continue
    ...
    def id_to_agent(self, team_list):
        """
        Maps a list of agent IDs (team_list) to their corresponding agent objects.
        If an ID is not found in `id2agent`, it will be logged or handled gracefully.
        """
        agent_list = []
        for agent_id in team_list:
            if agent_id in self.id2agent:
                ...
                print(f"Warning: Agent ID '{agent_id}' not found in id2agent.")
            # Handle missing ID (optional)
            # agent_list.append(DefaultAgent(agent_id))  # Optional: Define DefaultAgent
        return agent_list
